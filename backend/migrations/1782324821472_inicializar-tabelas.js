...
exports.down = (pgm) => {
	pgm.sql(`
    -- 1º: Apagar a tabela dependente (que tem as Foreign Keys)
    DROP TABLE IF EXISTS avaliacao;

    -- 2º e 3º: Apagar as tabelas base (a ordem entre estas duas não importa)
    DROP TABLE IF EXISTS livros;
    DROP TABLE IF EXISTS usuarios;
    
    -- Opcional: Remover a extensão se quiseres o ambiente 100% limpo
